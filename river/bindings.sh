...
riverctl map normal "Mod1" "space" spawn '/usr/local/bin/fuzzel -i "Papirus" -P "launch: " -s FFFACDff -t 5E81ACff -b 2e3440ff -r 0 -F exec -T foot -C 5E81ACff -f "mononoki Nerd Font:size=10" -x 30 -w 40 -y 70 -p 0 -l 20 --show-actions --fuzzy-min-length 10 -F "filename,name,keywords,comment,generic" -m 81a1c1ff'
